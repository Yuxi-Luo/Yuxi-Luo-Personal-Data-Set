...
This visualization shows that the "Game" genre has the most diverse styles. Analyzing from the perspective original work types of fan art which each has more than one style, I found that the most popular style in both Anime and Game genre is impasto, while the most popular style in Novel genres is realistic.

# Analysis
In this data project, I primarily used EDA techniques, and also employed linear regression analysis to analyze the linear relationship between Likes and Recommendations values. Overall, I believe EDA was a more suitable technique for this project because my dataset involved a large amount of categorical data, and the categories of data were quite complex. Therefore, using bar plots to count the number of arts in each category conveyed the information more clearly. In this project, I used heatmaps because I believe heatmaps can effectively show the trend of Likes under the influence of two different independent variables, which helped me solve more complex visualization problems. The first heatmap very intuitively showed the impact of extreme values ​​on visualization. I initially changed the calculation of the Likes mean to the median, but after finding that there was only one work in this style, I removed that extreme value.
I've learned from my practice in this project that while I want to present complex dynamics as much as possible, sometimes simple visualizations are better at showing the relationships between data.
